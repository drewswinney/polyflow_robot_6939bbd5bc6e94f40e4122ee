...
EOF
  ...
  in
  {
    ...
    nixosConfigurations.rpi4 = builtins.trace "Metadata values before loading configuration.nix:" (
      builtins.trace "  robotId: ${metadata.robotId}" (
      builtins.trace "  signalingUrl: ${metadata.signalingUrl}" (
      builtins.trace "  password: ${metadata.password}" (
      builtins.trace "  githubUser: ${metadata.githubUser}" (
      builtins.trace "  turnServerUrl: ${metadata.turnServerUrl}" (
      builtins.trace "  turnServerUsername: ${metadata.turnServerUsername}" (
      builtins.trace "  turnServerPassword: ${metadata.turnServerPassword}" (
